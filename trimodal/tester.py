...
def main():
    ...
    OUTPUT_PATH = os.path.join(output_path, 'trimodal-' + datetime.strftime(
    ...
    X_test_properties, X_test_pil, X_test_ch, y_test = util.get_raw_data(
        test_paths)
    ...
    test_dataset = util.CustomDataset(
        [X_test_properties, X_test_pil, X_test_ch], y_test)
