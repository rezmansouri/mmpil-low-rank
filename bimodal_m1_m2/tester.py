...
def main():
    ...
    OUTPUT_PATH = os.path.join(output_path, 'bimodal-m1-m2' + datetime.strftime(
    ...
    X_test_properties, X_test_pil, _, y_test = util.get_raw_data(
        test_paths)
    ...
    test_dataset = util.CustomDataset(
        [X_test_properties, X_test_pil], y_test)
